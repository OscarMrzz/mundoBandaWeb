...
const dataEstadisticas: estadisticaBandaInterface[] = await estadisticasServices.getDataBGL();
...
export const dataGraficaLiniarB: Record<string, DataLinearInterface> = {
  ascendente: {
